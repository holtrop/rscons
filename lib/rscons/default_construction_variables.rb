module Rscons
  ...
  DEFAULT_CONSTRUCTION_VARIABLES = {
    ...
    "SHDC" => "${DC}",
    "SHDC:-o" => "${DC:-o}",
    "SHDCCMD" => %w[${SHDC} -c ${SHDC:-o} ${_TARGET} ${INCPREFIX}${D_IMPORT_PATH} ${SHDFLAGS} ${_SOURCES}],
    "SHDCCMD:direct" => %w[${SHDC} ${SHDC:-o} ${_TARGET} ${INCPREFIX}${D_IMPORT_PATH} ${SHDFLAGS} ${SHLDFLAGS} ${_SOURCES} ${LIBDIRPREFIX}${LIBPATH} ${LIBLINKPREFIX}${LIBS}],
